...
<div class="app-content content ">
    ...
    <section id="dashboard-ecommerce">
            ...
            <h3 style="margin-top: 20px; color:#7367f0;" >Add New <strong>fabric </strong></h3> 
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="card  text-center " >
                <div class="card-body pb-50">
                <h3 style="margin-top: 20px; color:#7367f0;" >Total <strong>fabric</strong> </h3> 
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
        <div class="block full" >
            ...
            <div class="block-title" >
                <h2><strong>All</strong> fabric </h2>
            ...
            <table id="ecom-products"  class="table table-bordered table-striped table-vcenter">
                <thead >
                    <tr >
                        ...
                        <th class="text-center">fabric Image</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-xs">
                                <a href="{{route('editFabric',array('id' => $row->id))}}" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                <a href="{{route('deleteFabric', array('id' => $row->id))}}" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
                    @else
                    <p>No Fabric stored</p>
                    @endif
                </tbody>
            </table>
            </div>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form action="{{route('fabric')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
        <div class="form-group">
        <label class="col-md-12 control-label"> Enter New Fabric <span style="color: red"> * </span></label>
        <div class="col-md-12">
        ...
        <div class="row">
        <div class="form-group">
            <label class="col-md-12 control-label">Fabric Image <span style="color: red"> * </span></label>
            <div class="col-md-12">
