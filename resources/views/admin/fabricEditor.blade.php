...
<div class="app-content content ">
    ...
    <div class="row" style="margin-top: 50px;">
        ...
        <h2 class="text-center mt-3"> <strong>Edit</strong> Fabric </h2>
        ...
        <div class=" col-md-6 offset-md-3" style=" margin-top: 30px;">
            <form action="{{route('fabric_edit_indb')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label class="col-md-4 control-label" for="product-name">Name</label>
                    <div class="col-md-6">
                        <input type="text" id="product-name" name="fabric_name" class="form-control" value="{{$category->name}}">
                        @if ($errors->has('fabric_name')) <p style="color:red;">{{ $errors->first('fabric_name') }}</p> @endif 
                    </div>
                </div>
