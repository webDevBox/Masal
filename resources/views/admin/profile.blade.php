...
<div class="app-content content ">
    ...
    <div class="row" style="margin-top: 50px;">
        ...
        @if ($errors->has('old')) <p style="color:red;">{{ $errors->first('old') }}</p> @endif 
        ...
        <div class=" col-md-6 offset-md-3" style=" margin-top: 30px;">
            ...
            <div class="container mt-5 general" @if($errors->has('password') || $errors->has('confirm')) style="display:none;" @else style="justify-content: center;" @endif>
