...
<h1 class="text-center"><span class="grey">—</span> Edit {{ $template->name }} Template  <span class="grey">—</span></h1>
...
<form action="{{route('templateeditor')}}" method="POST" style="width: 50%; margin-left:25%;">
@csrf
<div class="row">
