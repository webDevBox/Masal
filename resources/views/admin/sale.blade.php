...
<div class="app-content content ">
    ...
    <section id="dashboard-ecommerce">
            ...
            <h3 style="margin-top: 20px;" >Add New <strong>Sales Tag</strong></h3> 
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="card  text-center " >
                <div class="card-body pb-50">
                <h3 style="margin-top: 20px;" >Total <strong>Tags</strong> </h3> 
                <h2 class="font-weight-bolder mb-1" style="margin-top: 30px;" > {{ count($sale) }} </h2>
                </div>
                </div>
            </a>
            </div>
