...
<div class="col-sm-6 col-lg-6">
    <a href="#" data-toggle="modal" data-target="#exampleModal2" class="widget widget-hover-effect2">
        <div class="widget-extra themed-background-success">
            <h4 class="widget-content-light"><strong>Add New</strong> Neckline</h4>
        </div>
...
<div class="col-sm-6 col-lg-6">
    <a href="javascript:void(0)" class="widget widget-hover-effect2">
        <div class="widget-extra themed-background-dark">
            <h4 class="widget-content-light"><strong>Total</strong> Neckline</h4>
        ...
        <tr>
            ...
            <td class="text-center">
                <div class="btn-group btn-group-xs">
                    <a href="{{route('editNeckline',array('id' => $row->id))}}" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil"></i></a>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="row">
    <div class="form-group">
    <label class="col-md-4 control-label"> Enter New Neckline <span style="color: red"> * </span></label>
    <div class="col-md-8">
    ...
    <div class="row">
    <div class="form-group">
        <label class="col-md-4 control-label">Neckline Image <span style="color: red"> * </span></label>
        <div class="col-md-8">
