...
<div class="app-content content ">
    ...
    <section id="dashboard-ecommerce">
            ...
            <h3 style="margin-top: 20px; color:#7367f0;" >Add New <strong>Sleeve </strong></h3> 
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="card  text-center " >
                <div class="card-body pb-50">
                <h3 style="margin-top: 20px; color:#7367f0;" >Total <strong>Sleeve</strong> </h3> 
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-xs">
                                <a href="{{route('editSleeve',array('id' => $row->id))}}" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <label class="col-md-12 control-label"> Enter New Sleeve <span style="color: red"> * </span></label>
        <div class="col-md-12">
        ...
        <div class="row">
        <div class="form-group">
            <label class="col-md-12 control-label">Sleeve Image <span style="color: red"> * </span></label>
            <div class="col-md-12">
