...
<head>
    ...
    <!--revslider-->
    <link rel="stylesheet" href="{{asset('css/revslider/settings.css')}}"> <!--revslider-->
                ...
                <div class="grid grid_6 right nicdark_bg_greydark percentage">
                    ...
                    <div class="nicdark_activity right nicdark_bg_green">
                        ...
                        <a class="" href="#" data-toggle="modal" data-target="#exampleModal1">
                            <span id="retailer_log" class="greydark nicdark_outline"> Retailer Login </span>
                        </a> </p>
                        <div class="nicdark_space5"></div>
                        </div>
                        @else
                        <div class="nicdark_activity right nicdark_bg_green">
                            ...
                            <i class="icon-lock"></i>&nbsp;&nbsp;
                            <a class="" href="#" data-toggle="modal" data-target="#exampleModal1">
                                <span class="greydark nicdark_outline"> Retailer Login </span>
                            </a> </p>
                            <div class="nicdark_space5"></div>
                            </div>
                        @endif
...
<!--end section-->        </div>
    ...
    <!--main-->
    <script src="{{asset('js/main/jquery.min.js')}}"></script> <!--Jquery-->
    <script src="{{asset('js/main/jquery-ui.js')}}"></script> <!--Jquery UI-->
    <script src="{{asset('js/main/excanvas.js')}}"></script> <!--canvas need for ie-->

    <!--plugins-->
    <script src="{{asset('js/plugins/revslider/jquery.themepunch.tools.min.js')}}"></script> <!--revslider-->
    <script src="{{asset('js/plugins/revslider/jquery.themepunch.revolution.min.js')}}"></script> <!--revslider-->

    <!--menu-->
    <script src="{{asset('js/plugins/menu/superfish.min.js')}}"></script> <!--superfish-->
    <script src="{{asset('js/plugins/menu/tinynav.min.js')}}"></script> <!--tinynav-->

    <!--other-->
    <script src="{{asset('js/plugins/isotope/isotope.pkgd.min.js')}}"></script> <!--isotope-->
    <script src="{{asset('js/plugins/mpopup/jquery.magnific-popup.min.js')}}"></script> <!--mpopup-->
    <script src="{{asset('js/plugins/scroolto/scroolto.js')}}"></script> <!--Scrool To-->
    <script src="{{asset('js/plugins/nicescrool/jquery.nicescroll.min.js')}}"></script> <!--Nice Scroll-->
    <script src="{{asset('js/plugins/inview/jquery.inview.min.js')}}"></script> <!--inview-->
    <script src="{{asset('js/plugins/parallax/jquery.parallax-1.1.3.js')}}"></script> <!--parallax-->
    <script src="{{asset('js/plugins/countto/jquery.countTo.js')}}"></script> <!--jquery.countTo-->
    <script src="{{asset('js/plugins/countdown/jquery.countdown.js')}}"></script> <!--countdown-->
    
    <!--settings-->
    <script src="{{asset('js/settings.js')}}"></script> <!--settings-->
<!--custom js-->
...
<script type="text/javascript">
    document.getElementById("retailer_log").click();
    </script>
