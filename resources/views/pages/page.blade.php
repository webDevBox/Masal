                           ...
                           <div class="list">
                               <div class="list-item">
                                   ...
                                   <a href="#" class="content-block content-img"
                                       ...
                                       <img src="{{ asset('images/'.$page->image1) }}"
            ...
            <section class="section-header section-featured-header" id="section-featured-header">
                <div class="container">
                    <div class="row">
                        <div class="header">
                            <h2>
                               @if($page->latest == 'prod') Latest Products @elseif($page->latest == 'cat') Latest Collection @endif
                            </h2>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="list" role="listbox" aria-label="Featured Products">
                                    ...
                                    @foreach ($latestProduct as $item)
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            <img src="{{ asset('images/'.$item->image1) }}" class="center-block" style="height: 500px; width:400px;" alt="">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <img src="{{ asset('images/'.$row->image) }}" class="center-block" style="height: 500px; width:400px;" alt="">
                                ...
                                <div class="list-item">
                                    <div class="content-blocks">
                                        <a href="#" class="content-block content-img"
                                            ...
                                            <img src="{{ asset('images/'.$page->image2) }}" alt="Photo of Masal">
                                        </a>
