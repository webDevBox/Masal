...
<img class="main_top_3" data-lazy="{{ asset($image1) }}" src="{{ asset($image1) }}" style="width: 740px; height:700px" 
alt="Masal Style #Y118JKT"/>
</a>
</div>
</div>
...
<img class="main_bot_3" data-lazy="{{ asset($image2) }}" src="{{ asset($image2) }}" style="width: 740px; height:700px"
alt="Masal Style #Y118JKT"/>
</a>
</div>
</div>
