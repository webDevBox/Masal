...
<div class="main-content" id="main" role="main">
    ...
    <div class="slider-bg desktop-bg has-background" style="background-image: url('slides/8d1ea58a_8d83_4ad8_a1d1_6b87a19c1408.jpg')">
    <img src="{{ asset('slides/8d1ea58a_8d83_4ad8_a1d1_6b87a19c1408.jpg') }}" alt=""/>
    </div>
    </div>
    ...
    <div class="content-blocks">
    <div class="content-block content-img has-background " style="background-image: url(<?php echo $img[0]; ?>);">
    <img src="<?php echo $img[2]; ?>" alt="Model in wedding dress by Masal">
    </div>
    ...
    <a href="#" class="featured-category">
    <div class="content-blocks">
    <div class="content-block content-img has-background" style="background-image: url(<?php echo $img[1]; ?>);">
    <img src="<?php echo $img[1]; ?>" alt="Model in yellow Sherri Hill dress">
    </div>
    ...
    <a href="#" class="featured-category">
    <div class="content-blocks">
    <div class="content-block content-img has-background" style="background-image: url(<?php echo $img[2]; ?>);">
    <img src="<?php echo $img[2]; ?>" alt="Brunette model in off the shoulder wedding dress">
    </div>
    <div class="content-block content-header">
    <h3>{{$copon[2]}}
    </h3>
    ...
    <div class="recommended-product featured-product">
    <a href="{{route('detail', array('id' => $item->id))}}" class="product product-simple" data-property="parent" data-product-id="448">
    <div class="product-image has-background" style="background-image: url(<?php echo $image; ?>)" data-img="default">
    <img src="<?php echo $image; ?>" alt="Clarissa" />
    </div>
    ...
    <div class="list-item">
    <div class="content-blocks">
    <a href="#" class="content-block content-img has-background" style="background-image: url(<?php echo $image2; ?>);">
