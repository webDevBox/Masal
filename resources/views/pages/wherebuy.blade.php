...
<section class="nicdark_section">
    ...
    <form action="{{route('mapper')}}" method="post">
        ...
        <div class="grid grid_12" style="margin-top: 80px;">
            <h1 class="grey2 center every_page_top_on_small"><span class="grey">—</span> Where to Buy  <span class="grey">—</span></h1>
...
@endif
            ...
            <div class="form-group  grid grid_3">
   ...
   <center> <input class="btn btn-primary my-2" name="search" type="submit" value="Search"> </center>
</form>  
