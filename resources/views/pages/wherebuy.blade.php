...
<body class="page-moncheri page-home " id="start1">
    ...
    <section class="nicdark_section">
            ...
            <form action="{{ route('mapper') }}" method="post">
                ...
                <div class="col-md-12" style="margin-top: 80px;">
                    ...
                    <div class="form-group  col-md-4">
                        <select class="form-control" name="country" id="country" style="height:40px;border-radius:8px" required>
        ...
        <center> <input class="btn btn-success  " style="border-radius:8px" name="search" type="submit" value="Search"> </center>
        </form>
        <br><br><br>
...
<script>
    jQuery(function($) {
        window.Syvo.Google_Analytics.load({
            "TrackingCode": "UA-11484610-13",
            "Event": 0,
            "Parameters": null
        });
    });
...
<script>
    jQuery(function($) {
        $("#privacyPolicyAcceptance button").click(function() {
            $.cookie("privacyPolicyAccepted", true, {
                expires: 365,
                path: "/"
            });
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-59538BB" height="0" width="0"
