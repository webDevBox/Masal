    ...
    <section class="nicdark_section">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            @if ($errors->has('registration'))
                <p style="color:red;">{{ $errors->first('registration') }}</p>
            @endif
            ...
            <form action="#" method="POST">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <input type="text" placeholder="Contact Name" value="{{ old('contact') }}" name="contact"
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <input type="tel" name="phone" value="{{ old('phone') }}" class="custom-form-control"
                            style="border-radius:8px" id="Shop Name" placeholder="Your Phone Number" required>
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <select class="custom-form-control" name="country" id="country_top" style="border-radius:8px"
                            required>
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <select name="state" class="custom-form-control" id="state_top" style="border-radius:8px">
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <input type="text" value="{{ old('city') }}" name="city" class="custom-form-control"
                            style="border-radius:8px" id="Shop Name" placeholder="Your City" required>
                    </div>

                    <div class="form-group col-md-6 col-sm-6">
                        <label for="">Postcode <span style="color: red;">*</span></label>
                        <input type="text" value="{{ old('post') }}" name="post" class="custom-form-control"
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <input type="text" value="{{ old('website') }}" name="website" style="border-radius:8px"
                            class="custom-form-control" id="Shop Name" placeholder="Your Website" required>

                    </div>
                    <div class="form-group col-md-6 col-sm-6">
                        <label for="">Facebook <span style="color: red;">*</span></label>
                        <input type="text" value="{{ old('facebook') }}" name="facebook" style="border-radius:8px"
                ...
                <div class=" submit-button-holder text-center">
                    <center> <input class="btn btn-success" style="border-radius:8px; width:200px;" name="register" type="submit"
                            value="Register">
                    </center>
                </div>
            </form>
