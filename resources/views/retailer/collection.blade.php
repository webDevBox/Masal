...
<h1 class="grey2 text-center"><span class="grey">—</span> Products @if($status == 1) of {{$cat_product}} @endif <span class="grey">—</span> </h1>
...
<div class="col-sm-2 col-md-2 col-xs-2 col-lg-2" style="margin-top: 20px;">
...
<a href="{{route('retailerorder',array('id'=>$row->id))}}" class=" btn btn-primary">ORDER NOW</a>
</div>
</div>
